...
void tsp()
{
    ...
    void welcome(){
       ...
       system("color 0E");
        cout<<"\n      ppppppppp    ppppppppppp    pppppppp   ppppppppppp   ";
        ...
        cout<<"\n      ppppppppp    ppp     ppp    pppppppp       ppp       ";
        cout<<"\n      ppp          ppp     ppp          pp       ppp       ";

        Sleep(800);system("color 0F");
        cout<<"\n      ppp          ppp     ppp          pp       ppp       ";
        cout<<"\n      ppp          ppppppppppp    pppppppp       ppp       ";
        cout << "\n\n";

        Sleep(800);system("color 0C");
        cout<<"\n      ooooooooooo   oooooooo   oooooooo  ooooooooooo  ooooooooo    ooooooooo ";
        cout<<"\n      ooo     ooo   oo         oo            ooo      oo           oo        ";

        Sleep(800);system("color 0B");
        cout<<"\n      ooo     ooo   oo         oo            ooo      oo           oo        ";
        cout<<"\n      ooo     ooo   oo         oo            ooo      oo           oooooooo  ";


        system("color 0E");
        cout<<"\n      ooo     ooo   oooooooo   oooooooo      ooo      oo           oooooooo  ";
        cout<<"\n      ooo     ooo   oo         oo            ooo      oo           oo        ";


        Sleep(800);system("color 0A");
        cout<<"\n      ooo     ooo   oo         oo            ooo      oo           oo        ";
        cout<<"\n      ooooooooooo   oo         oo        ooooooooooo  ooooooooo    ooooooooo ";
cout << "\n\n";


        Sleep(800);system("color 0D");
        cout<<"\n      ggggggggggg   gg     gg   ggggggggggg  ggggggggg       ggggggggg   ";
        cout<<"\n      ggg           gg     gg       ggg      gg       gg     gg          ";

        Sleep(800);system("color 0F");
        cout<<"\n      ggg           gg     gg       ggg      gg        gg    gg          ";
        cout<<"\n      ggg           gg     gg       ggg      gg         gg   gggggggg    ";

        Sleep(800);system("color 0C");
        cout<<"\n      ggg  gggggg   gg     gg       ggg      gg         gg   gggggggg    ";
        cout<<"\n      ggg     ggg   gg     gg       ggg      gg        gg    gg          ";

        Sleep(800);system("color 0B");
        cout<<"\n      ggg     ggg   gg     gg       ggg      gg       gg     gg          ";
        cout<<"\n      ggggggggggg   ggggggggg   ggggggggggg  ggggggggg       ggggggggg   ";
cout << "\n\n";
    }
